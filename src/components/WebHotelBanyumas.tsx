...
const BanyumasHotelWebsite: React.FC = () => {
  useEffect(() => {
  ...
  const benefits = [
    {
      ...
      description: "Tampil di pencarian Google untuk wisatawan yang mencari penginapan di Banyumas"
    },
    {
    ...
    },
    {
      ...
      description: "Layani pertanyaan wisatawan tentang Banyumas 24 jam nonstop"
    },
    {
  ...
  const features = [
    ...
    "Galeri foto kamar dan wisata alam",
    "Info wisata Banyumas terintegrasi",
    "Integrasi Google Maps",
    "SEO optimization untuk Banyumas",
    "SSL certificate gratis"
  ];

  const packages = [
    {
      name: "Starter Banyumas",
      price: "Rp 499.000",
      originalPrice: "Rp 700.000",
      features: [
        "1 halaman landing page",
        "Desain tema alam Banyumas",
        "Booking WhatsApp",
        "Domain .my.id gratis",
        "Hosting 3 bulan",
        "1x revisi gratis"
  ...
  const createWhatsAppLink = (packageName: string) => {
    const message = encodeURIComponent(
      `Halo, saya tertarik dengan paket ${packageName} untuk website hotel di Banyumas. Boleh tahu informasi lebih detail?`
    );
  ...
  return (
    <>
      <SEO 
        title="Jasa Pembuatan Website Hotel di Banyumas"
        description="Jasa pembuatan website hotel profesional di Banyumas mulai Rp 499rb. Dilengkapi booking WhatsApp, AI customer service 24/7, dan domain gratis. Cocok untuk hotel, penginapan, dan homestay di kabupaten Banyumas."
        canonical="https://citradigitalhotel.com/web-hotel-banyumas"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Jasa Website Hotel Banyumas</span>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
            Jasa Pembuatan Website Hotel di Banyumas
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Tingkatkan okupansi hotel Anda di kabupaten Banyumas dengan website profesional. 
            Dilengkapi booking WhatsApp otomatis dan AI customer service 24/7.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={createWhatsAppLink("Professional Banyumas")}
              target="_blank"
        ...
        <div className="bg-blue-50 rounded-2xl p-8 mb-16">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Mengapa Hotel di Banyumas Butuh Website?</h2>
              <p className="text-gray-700 mb-4">
                Banyumas memiliki wisata alam yang indah seperti Curug Cipendok, Baturaden, dan 
                berbagai destinasi pegunungan. Kabupaten ini menarik wisatawan yang mencari 
                ketenangan alam dan udara sejuk.
              </p>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">
            Manfaat Website Hotel untuk Bisnis Anda di Banyumas
          </h2>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-400 rounded-2xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Siap Tingkatkan Booking Hotel Anda di Banyumas?
          </h2>
          <p className="text-xl mb-8 text-green-100">
            Jangan biarkan wisatawan alam memilih kompetitor. Mulai digitalisasi hotel Anda sekarang!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
        ...
        <div className="mt-16 text-center">
          <h3 className="text-xl font-semibold mb-4">Area Layanan di Banyumas</h3>
          <p className="text-gray-600">
            Kami melayani pembuatan website hotel di seluruh area Banyumas: Purwokerto, Baturaden, 
            Sokaraja, Kembaran, dan sekitarnya. Khusus untuk hotel dekat wisata alam dan pegunungan.
          </p>
        </div>
      </div>
    </>
...
export default BanyumasHotelWebsite;