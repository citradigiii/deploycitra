...
const SemarangHotelWebsite: React.FC = () => {
  useEffect(() => {
  ...
  const benefits = [
    {
      ...
      title: "Visibilitas Online Maksimal",
      description: "Tampil di halaman pertama Google untuk pencarian hotel di Semarang"
    },
    {
      icon: <FaWhatsapp className="w-6 h-6 text-green-500" />,
      title: "Booking WhatsApp Otomatis",
      description: "Tamu bisa langsung pesan kamar via WhatsApp dengan satu klik"
    },
    {
      icon: <Zap className="w-6 h-6 text-yellow-500" />,
      title: "AI Customer Service 24/7",
      description: "Chatbot pintar yang melayani pertanyaan tamu sepanjang waktu"
    },
    {
      icon: <Users className="w-6 h-6 text-purple-500" />,
      title: "Manajemen Tamu Digital",
      description: "Kelola reservasi dan data tamu dengan sistem yang terintegrasi"
    }
  ];
  ...
  const features = [
    ...
    "Galeri foto kamar profesional",
    "Halaman fasilitas lengkap",
  ...
  const createWhatsAppLink = (packageName: string) => {
    const message = encodeURIComponent(
      `Halo, saya tertarik dengan paket ${packageName} untuk website hotel di Semarang. Boleh tahu informasi lebih detail?`
    );
  ...
  return (
    <>
      <SEO 
        title="Jasa Pembuatan Website Hotel di Semarang"
        description="Jasa pembuatan website hotel profesional di Semarang mulai Rp 499rb. Dilengkapi booking WhatsApp, AI customer service 24/7, dan domain gratis. Cocok untuk hotel, penginapan, dan homestay di Semarang."
        canonical="https://citradigitalhotel.com/web-hotel-semarang"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Jasa Website Hotel Semarang</span>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
            Jasa Pembuatan Website Hotel di Semarang
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Tingkatkan okupansi hotel Anda di Semarang dengan website profesional. 
            Dilengkapi booking WhatsApp otomatis dan AI customer service 24/7.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={createWhatsAppLink("Professional Semarang")}
              target="_blank"
        ...
        <div className="bg-blue-50 rounded-2xl p-8 mb-16">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Mengapa Hotel di Semarang Butuh Website?</h2>
              <p className="text-gray-700 mb-4">
                Sebagai ibu kota Jawa Tengah dan pusat bisnis utama, Semarang menarik ribuan wisatawan 
                dan pebisnis setiap bulannya. Area seperti Simpang Lima, Kota Lama, dan Lawang Sewu 
                menjadi magnet wisata yang membutuhkan akomodasi berkualitas.
              </p>
              <p className="text-gray-700">
                Dengan persaingan hotel yang ketat di Semarang, memiliki website profesional bukan lagi 
                pilihan—tapi keharusan untuk memenangkan kepercayaan tamu dan meningkatkan booking.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">
            Manfaat Website Hotel untuk Bisnis Anda di Semarang
          </h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">
            Testimoni Klien Hotel di Semarang
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 mb-4">
                "Website dari Citra Digital Hotel sangat membantu meningkatkan booking hotel kami di area Simpang Lima. 
                Fitur booking WhatsApp-nya praktis banget!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                  <span className="font-semibold text-blue-600">BH</span>
                </div>
                <div>
                  <p className="font-semibold">Budi Hartono</p>
                  <p className="text-sm text-gray-600">Pemilik Hotel Bintang, Semarang</p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 mb-4">
                "AI customer service-nya keren! Tamu bisa dapat info kamar 24 jam tanpa saya harus standby terus. 
                Booking naik 30% sejak pakai website ini."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                  <span className="font-semibold text-purple-600">SR</span>
                </div>
                <div>
                  <p className="font-semibold">Sari Rahayu</p>
                  <p className="text-sm text-gray-600">Pemilik Homestay Kota Lama</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">
            Pertanyaan Seputar Website Hotel Semarang
          </h2>
          <div className="space-y-6">
            {[
              {
                q: "Berapa lama proses pembuatan website hotel di Semarang?",
                a: "Untuk paket Starter: 1-3 hari kerja. Paket Professional: 3-5 hari kerja. Paket Premium: 5-7 hari kerja."
              },
              {
                q: "Apakah website bisa diakses dari HP?",
                a: "Ya, semua website yang kami buat sudah responsive dan optimal untuk smartphone, tablet, dan desktop."
              },
              {
              ...
              },
              {
                ...
                a: "Tidak ada biaya maintenance wajib. Hosting dan domain sudah termasuk sesuai paket yang dipilih."
              }
            ].map((faq, index) => (
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-400 rounded-2xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Siap Tingkatkan Booking Hotel Anda di Semarang?
          </h2>
          <p className="text-xl mb-8 text-green-100">
            Jangan biarkan kompetitor unggul lebih dulu. Mulai digitalisasi hotel Anda sekarang!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
        ...
        <div className="mt-16 text-center">
          <h3 className="text-xl font-semibold mb-4">Area Layanan di Semarang</h3>
          <p className="text-gray-600">
            Kami melayani pembuatan website hotel di seluruh area Semarang: Simpang Lima, Kota Lama, 
            Pandanaran, Pemuda, Gajah Mada, Kaligawe, Banyumanik, Tembalang, dan sekitarnya.
          </p>
        </div>
      </div>
    </>
...
export default SemarangHotelWebsite;